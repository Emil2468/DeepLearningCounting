...
# This is the model as used in https://www.nature.com/articles/s41586-020-2824-5
...
def UNet(input_shape,
    ...
    """ Method to declare the UNet model.
        ...
        Args:
            ...
            n_output_channels: int
                used for calculating the number of channels in model output.
    ...
    gaussian_noise_layer = layers.GaussianNoise(gaussian_noise)(pp_in_layer)
    n0 = layers.BatchNormalization()(gaussian_noise_layer)
    c1 = layers.Conv2D(1 * layer_count, (3, 3), activation='relu', padding='same')(n0)
    ...
    d = layers.Conv2D(n_output_channels, (1, 1),
                      activation='sigmoid',
                      kernel_regularizer=regularizers)(c9)
